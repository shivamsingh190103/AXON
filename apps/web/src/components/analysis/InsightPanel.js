...
export function InsightPanel({ overallScore, hookScore, boredomScore, emotionScore, hookValues, boredomValues, emotionValues, currentSecond, insights, analysisFormat, onSeek, onShare, onExport, onDelete }) {
    ...
    const formatBadgeLabel = analysisFormat === 'SHORT_FORM'
        ? 'Short-Form Analysis'
        : analysisFormat === 'LONG_FORM'
            ? 'Long-Form Analysis'
            : 'Standard Analysis';
    return (_jsxs("aside", { className: "space-y-3 overflow-y-auto", children: [_jsxs("section", { className: "liquid-glass rounded-2xl p-4", children: [_jsxs("div", { className: "mb-4 flex items-center justify-between", children: [_jsx("h3", { className: "display text-lg font-bold", children: "Neural Score" }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Badge, { color: "default", children: formatBadgeLabel }), _jsx(Badge, { color: "default", children: "Overall" })] })] }), _jsxs("div", { className: "flex items-center justify-between gap-3", children: [_jsx(ScoreRing, { score: overallScore }), _jsxs("div", { className: "text-right", children: [_jsx(Badge, { color: overallScore > 70 ? 'green' : overallScore > 40 ? 'amber' : 'red', children: scoreSummary(overallScore) }), _jsx("p", { className: "mt-2 text-xs text-slate-400", style: { color: scoreToColor(overallScore) }, children: "Higher score means better biological retention prediction." })] })] })] }), _jsxs("section", { className: "liquid-glass rounded-2xl p-4", children: [_jsx("p", { className: "mb-2 text-xs uppercase tracking-[0.12em] text-slate-400", children: "Metrics" }), _jsx("div", { className: "space-y-2", children: [
