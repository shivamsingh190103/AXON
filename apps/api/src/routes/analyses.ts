...
import { enforceUploadTypeLimits, uploadVideoMiddleware } from '../middleware/upload.js'
...
router.post('/upload', uploadRateLimit, uploadVideoMiddleware.single('video'), enforceUploadTypeLimits, asyncHandler(analysisController.upload))
